...
{
  type __IsExpected<Specific extends AppPageConfig<"/all-articles">> = Specific
...
// Validate ../../src/app/api/ingest/posts/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/ingest/posts">> = Specific
  const handler = {} as typeof import("../../src/app/api/ingest/posts/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
